DEMO：https://uyarh62jbv6czgrxrkeo7d.streamlit.app/

1. 業務理解（Business Understanding）
我們的目標仍是預測房屋價格，但這次使用 1000 筆模擬資料。這樣的模型可以幫助房地產業者快速估算房屋價值，並做出更精準的定價策略。

🔍 2. 資料理解（Data Understanding）
我們使用 NumPy 來生成模擬資料。假設房屋面積在 20 到 200 平方公尺之間，價格與面積呈線性關係，但加入一些隨機雜訊來模擬真實世界的波動。
